...
[![Status: v2.3.3](https://img.shields.io/badge/Status-v2.3.3-brightgreen.svg)](#)
[![BSAU: v2.4](https://img.shields.io/badge/BSAU-v2.4-blue.svg)](bsau_v2/README.md)
[![CPCU: v2.3.3](https://img.shields.io/badge/CPCU-v2.3.3-blue.svg)](cpcu_v2/README.md)
...
./run_tests.sh 1                    # → 7+38+28+30+65 = 168 PASS
...
└── cpcu_v2/             ← Raspberry Pi 5 application (CMake + Python)
    ...
    ├── test/            ← 5 testbenches + 2 Python tests (168 PASS total)
